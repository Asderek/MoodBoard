...
func _setup_environment():
	...
	if Global.selected_background != "" and (ResourceLoader.exists(Global.selected_background) or FileAccess.file_exists(ProjectSettings.globalize_path(Global.selected_background))):
		...
		# Fallback Search
		var potential_paths = ["res://backgrounds/teste2.png","res://backgrounds/teste.jpg", "res://backgrounds/stars.jpg", "res://backgrounds/universe.png", "res://backgrounds/universe.jpg", "res://stars.jpg", "res://universe.png"]
